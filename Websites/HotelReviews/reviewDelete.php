...
$hotelId = $_POST['hotelId']; // for back button
    ...
    <body>
        ...
        <div align="center">
            <div class="card text-dark bg-light mb-3" style="max-width: 30rem;">
                <div class="card-body">
                    <h2 class="card-title">Delete Review</h2><br/>
                    <div align="left">
                        <p>
                            <b>Hotel Name:</b><br/>
                            ...
                            <b>Date:</b><br/>
                            <?php echo $datePosted ?><br/><br/>
                        </p>
                    </div>
                    <form action="doReviewDelete.php?reviewId=<?php echo $reviewId?>" method="post" >
                        <input type ="submit" value="Confirm Delete Review" class="btn btn-dark"><br/>
