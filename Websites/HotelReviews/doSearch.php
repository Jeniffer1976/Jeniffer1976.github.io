...
<html>
    ...
    <body>
        ...
        if(!$haveSearch){
        ?> 
        <h4 style="margin-top: 30px; text-align: center; font-weight: bold">Search results not found!</h4>
        <?php } else { ?>
        <div align="center" style="margin-top: 15px" >
            <h3 style="font-weight: bold">Search results for - <?php echo $search ?></h3><br/>
